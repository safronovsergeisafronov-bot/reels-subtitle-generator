  ...
  return (
    <div className="flex items-center gap-1.5 shrink-0">
      ...
      <select
        ...
        className="bg-zinc-800 border border-zinc-700 rounded-lg px-1.5 py-1 text-xs text-zinc-200 outline-none focus:border-indigo-500 transition-colors cursor-pointer appearance-none pr-6"
        style={{
